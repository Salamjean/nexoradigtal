    ...
    <section class="relative flex flex-col justify-center gap-10 pt-40 pb-14 px-4 sm:px-8 bg-slate-950 overflow-hidden min-h-screen">
        ...
        <div class="relative z-10 max-w-7xl mx-auto w-full text-center">
            <h1 class="text-white font-heading font-bold text-[clamp(1.25rem,5.8vw,7.1875rem)] uppercase leading-[0.9] whitespace-nowrap drop-shadow-[0_15px_35px_rgba(0,0,0,0.8)] select-none">
                @php $heroLetters = str_split('NEXORA DIGITAL SARL'); @endphp
        ...
        <!-- Bottom widgets: team avatars pill (left) / project showcase card (right) -->
        <div class="relative z-10 max-w-7xl mx-auto w-full flex flex-col lg:flex-row items-end justify-between gap-6 mt-auto">
            ...
            <!-- Bottom Right: Interactive Showcase Card (Derniers projets) -->
            <div x-data="{
                currentProject: 1,
                totalProjects: 4,
                projects: [
                    { id: 1, title: 'Plateau-Apps', category: 'Derniers projets' },
                    { id: 2, title: 'Nexora ERP', category: 'Derniers projets' },
                    { id: 3, title: 'Smart City CI', category: 'Derniers projets' },
                    { id: 4, title: 'GovPort Web', category: 'Derniers projets' }
                ],
                next() {
                ...
                <div class="flex items-center gap-4">
                    <!-- Project Image Preview Box (photo + tilted phone mockup) -->
                    <div class="w-1/2 h-44 sm:h-48 rounded-2xl relative overflow-hidden flex items-center justify-center shadow-inner group">
                        <img src="{{ asset('assets/img/figma_hero_card_bg.png') }}" alt="" class="absolute inset-0 w-full h-full object-cover">
                        <div class="absolute inset-0 bg-blue-950/40 group-hover:bg-blue-950/20 transition-all duration-500"></div>
                        <img src="{{ asset('assets/img/figma_hero_phone_mockup.png') }}" alt="Aperçu de l'application" class="relative z-10 h-[92%] object-contain rotate-[16deg] filter drop-shadow-[0_15px_20px_rgba(0,0,0,0.6)] group-hover:scale-105 group-hover:rotate-12 transition-transform duration-500">
                    </div>
    ...
    <section id="projets" class="py-20 bg-[#ECEEF0] relative overflow-hidden">
        ...
        <!-- Floating Phone Button on the right edge of the screen -->
        <a href="tel:+2250171755000" aria-label="Contactez-nous" class="hidden sm:flex fixed right-4 sm:right-8 top-1/2 -translate-y-1/2 w-12 h-12 rounded-full bg-blue-600 hover:bg-blue-500 text-white items-center justify-center shadow-xl shadow-blue-600/40 transition-all duration-300 hover:scale-110 z-40">
